					...
					<div className="navbar-translate header-options">
						...
						<Nav tabs className="menu-items">
							<NavItem className="menu-leaf">
								<NavLink to="/sobre-la-universidad" className="nav-link">SOBRE LA UNIVERSIDAD</NavLink>
							</NavItem>
							<NavItem className="menu-leaf">
								<NavLink to="/estudios" className="nav-link">OFERTA ACADÉMICA</NavLink>
							</NavItem>
							<NavItem className="menu-leaf">
								<NavLink to="/cultura-y-extensiones" className="nav-link">CULTURA Y EXTENSIONES</NavLink>
							</NavItem>
							<NavItem className="menu-leaf">
								<NavLink to="/revista-germinal" className="nav-link">REVISTA GERMINAL</NavLink>
							</NavItem>
							<NavItem className="menu-leaf">
