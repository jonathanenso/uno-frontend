...
import { Col, Row, Button, Form, FormText, FormGroup, Label, Input, Container, NavItem, NavLink, Nav, Card, CardHeader, CardBody, TabContent, TabPane, Alert  } from 'reactstrap';
// core components
                                    ...
                                    <CardBody>
                                        ...
                                        >
                                                ...
                                                <Form onSubmit={handleSubmit(onUpdateData)} className="form">
                                                    ...
                                                    <Row form>
                                                        ...
                                                        <FormGroup>
                                                            ...
                                                            <Datetime locale="Es-es" timeFormat={false} defaultValue={moment(user.birthday).format('YYYY-MM-DD')}
                                                                isValidDate={ valid }
                                            ...
                                            <TabPane tabId="plainTabs3">
                                                ...
                                                <Button color="primary" disabled={!completedCrop?.width || !completedCrop?.height}
                                                ...
                                                <Button color="neutral" disabled={!completedCrop?.width || !completedCrop?.height}
                                                    onClick={() =>cleanCrop()}
                                                 >
                                                    Cancelar
                                                </Button>
